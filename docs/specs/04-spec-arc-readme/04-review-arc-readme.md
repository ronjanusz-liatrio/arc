...
- **Files**: `skills/arc-sync/SKILL.md:333-336`, `skills/arc-sync/references/readme-mapping.md:216-219`
- **Severity**: Blocking
...
- **Files**: `skills/arc-sync/SKILL.md:316-337`, `skills/arc-sync/references/readme-mapping.md:206-214`
- **Severity**: Blocking
...
- **Files**: `skills/arc-sync/SKILL.md:173-289`, `skills/arc-sync/references/readme-mapping.md:57-223`
- **Severity**: Blocking
...
- **Files**: `skills/arc-sync/references/readme-mapping.md:168`, `skills/arc-sync/SKILL.md:272`, `skills/arc-sync/references/readme-quality-rules.md:101`
- **Severity**: Blocking
...
- **File**: `skills/arc-sync/SKILL.md:215,287`
- **Severity**: Blocking
...
### [A1] Pipeline diagrams show /arc-sync as mandatory step
- **Files**: `README.md:69,105`, `skills/README.md:17`
- **Description**: Mermaid and ASCII diagrams place arc-sync as a hard edge in the pipeline. Spec says it's "offered after arc-wave" — should use dotted edge for optionality.

### [A2] TS-5 detection regex may not match readme-mapping.md diagram syntax
- **File**: `skills/arc-sync/references/trust-signals.md:143`
...
- **File**: `skills/arc-sync/references/readme-quality-rules.md:159-161`
...
- **File**: `skills/arc-audit/SKILL.md:304-326`
- **Description**: The arc-sync option appears when any signal fails, but severity is only warning below 75%. Technically correct but potentially confusing.

### [A5] WA-7 in audit-dimensions.md duplicates trust-signals.md
- **File**: `skills/arc-audit/references/audit-dimensions.md:429-480`
...
- **File**: `skills/arc-sync/SKILL.md:347-362`
...
- **File**: `skills/arc-sync/SKILL.md:16-19`
- **Description**: Overview omits injection mode (Step 2a).

### [A8] Inconsistent cross-reference path prefixes
- **Files**: `skills/arc-audit/references/review-report-template.md:99,172`, `audit-dimensions.md:533`
...
- **Description**: Lists arc-assess last, pipeline puts it first.

### [A10] Lifecycle diagram backward transitions inconsistent between docs
- **File**: `skills/arc-sync/SKILL.md:325-326`
...
- **File**: `skills/arc-sync/references/readme-quality-rules.md`
...
| File | Status | Issues |
|------|--------|--------|
| `skills/arc-sync/SKILL.md` | New | 3 blocking, 3 advisory |
| `skills/arc-sync/references/readme-mapping.md` | New | 3 blocking, 1 advisory |
| `skills/arc-sync/references/readme-quality-rules.md` | New | 1 blocking (shared), 2 advisory |
| `skills/arc-sync/references/trust-signals.md` | New | 1 advisory |
| `skills/arc-audit/SKILL.md` | Modified | 1 advisory |
| `skills/arc-audit/references/audit-dimensions.md` | Modified | 1 advisory |
| `skills/arc-audit/references/review-report-template.md` | Modified | 1 advisory |
