...
Feature: /arc-audit Skill

  Scenario: Skill definition follows plugin conventions
    Given the arc plugin is installed in a project
    When the user inspects skills/arc-audit/SKILL.md
    Then the frontmatter contains name set to "arc-audit"
  ...
  Scenario: Review begins with context marker
    Given the arc plugin is installed in a project
    When the user invokes /arc-audit
  ...
  Scenario: Review allows configurable staleness threshold
    ...
    When the user invokes /arc-audit and adjusts the staleness threshold to 7 days
  ...
  Scenario: Review offers interactive fixes for stale ideas
    ...
    When the user invokes /arc-audit and the review completes
  ...
  Scenario: Review offers interactive fix for summary table mismatches
    ...
    When the user invokes /arc-audit and selects the fix
  ...
  Scenario: Review offers interactive fix for broken ROADMAP references
    ...
    When the user invokes /arc-audit and selects the fix with user confirmation
  ...
  Scenario: Review never modifies VISION.md or CUSTOMER.md
    ...
    When the user invokes /arc-audit and applies all offered fixes
  ...
  Scenario: Audit dimensions reference document exists
    Given the arc plugin is installed in a project
    When the user inspects skills/arc-audit/references/audit-dimensions.md
  ...
  Scenario: Review report template reference document exists
    Given the arc plugin is installed in a project
    When the user inspects skills/arc-audit/references/review-report-template.md
