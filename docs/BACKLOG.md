...
| [(deferred) External tool integration](#deferred-external-tool-integration) | captured | P3-Low | -- |
| [(deferred) Custom labels or properties](#deferred-custom-labels-or-properties) | captured | P3-Low | -- |
| [(deferred) Team or role assignment](#deferred-team-or-role-assignment) | captured | P3-Low | -- |
| [(deferred) Executable code or tests](#deferred-executable-code-or-tests) | captured | P3-Low | -- |
| [(deferred) CI/CD pipeline](#deferred-cicd-pipeline) | captured | P3-Low | -- |
| [(deferred) Proof execution for spec 01](#deferred-proof-execution-for-spec-01) | captured | P3-Low | -- |
| [(deferred) Automated fix application](#deferred-automated-fix-application) | captured | P3-Low | -- |
| [(deferred) VISION or CUSTOMER content editing](#deferred-vision-or-customer-content-editing) | captured | P3-Low | -- |
| [(deferred) New templates or reference docs](#deferred-new-templates-or-reference-docs) | captured | P3-Low | -- |
| [(deferred) Backward-incompatible changes](#deferred-backward-incompatible-changes) | captured | P3-Low | -- |
| [(deferred) Temper-managed README sections](#deferred-temper-managed-readme-sections) | captured | P3-Low | -- |
| [(deferred) LICENSE, CONTRIBUTING, CHANGELOG files](#deferred-license-contributing-changelog-files) | captured | P3-Low | -- |
| [(deferred) External link validation or badges](#deferred-external-link-validation-or-badges) | captured | P3-Low | -- |
| [(deferred) Automatic invocation](#deferred-automatic-invocation) | captured | P3-Low | -- |
| [(deferred) Managing subdirectory READMEs](#deferred-managing-subdirectory-readmes) | captured | P3-Low | -- |
| [(deferred) Full readme-author runtime integration](#deferred-full-readme-author-runtime-integration) | captured | P3-Low | -- |
| [(deferred) Dynamic help content](#deferred-dynamic-help-content) | captured | P3-Low | -- |
| [(deferred) Argument parsing or per-skill views](#deferred-argument-parsing-or-per-skill-views) | captured | P3-Low | -- |
| [(deferred) Interactive menus or topic selection](#deferred-interactive-menus-or-topic-selection) | captured | P3-Low | -- |
| [(deferred) Versioned help output](#deferred-versioned-help-output) | captured | P3-Low | -- |
| [(deferred) Modifying existing skills via help](#deferred-modifying-existing-skills-via-help) | captured | P3-Low | -- |
| [(deferred) Automatic spec deduplication](#deferred-automatic-spec-deduplication) | captured | P3-Low | -- |
| [(deferred) ROADMAP artifact population via assess](#deferred-roadmap-artifact-population-via-assess) | captured | P3-Low | -- |
| [(deferred) Code refactoring suggestions](#deferred-code-refactoring-suggestions) | captured | P3-Low | -- |
| [(deferred) Modifying existing specs](#deferred-modifying-existing-specs) | captured | P3-Low | -- |
...
| [(deferred) Changing backlog data format](#deferred-changing-backlog-data-format) | captured | P3-Low | -- |
| [(deferred) Modifying other skills from capture](#deferred-modifying-other-skills-from-capture) | captured | P3-Low | -- |
...
No metrics collection, velocity tracking, or burndown charts
...
## (deferred) External tool integration
...
No Linear, Jira, or GitHub Issues sync (future consideration)

## (deferred) Custom labels or properties
...
Only priority (P0-P3) and status fields on ideas

## (deferred) Team or role assignment
...
Handled by claude-workflow's /cw-plan and /cw-dispatch

## (deferred) Executable code or tests
...
Pure markdown plugin; validation via SDD proof artifacts and Gherkin BDD
...
No GitHub Actions or automation in this iteration
...
## (deferred) Automated fix application
...
/arc-audit offers interactive fixes with user confirmation, not batch auto-fixes
...
## (deferred) New templates or reference docs
...
No changes to existing templates/ or references/ beyond what /arc-audit needs

## (deferred) Backward-incompatible changes
...
All existing skills, templates, and references remain unchanged

## (deferred) Temper-managed README sections

- **Status:** captured
- **Priority:** P3-Low
- **Captured:** 2026-04-12T18:00:00Z
<!-- aligned-from: docs/specs/04-spec-arc-readme/04-spec-arc-readme.md:163-170 -->
<!-- aligned-from-spec: 04-spec-arc-readme -->

Temper handles its own phase-level README concerns

## (deferred) LICENSE, CONTRIBUTING, CHANGELOG files
...
## (deferred) External link validation or badges
...
readme-author's domain

## (deferred) Automatic invocation
...
/arc-sync is always user-triggered or suggested, never auto-executed

## (deferred) Managing subdirectory READMEs
...
## (deferred) Full readme-author runtime integration
...
Quality rules are adapted as reference docs, not enforced by calling readme-author

## (deferred) Dynamic help content

- **Status:** captured
- **Priority:** P3-Low
- **Captured:** 2026-04-12T18:00:00Z
<!-- aligned-from: docs/specs/05-spec-arc-help/05-spec-arc-help.md:59-63 -->
<!-- aligned-from-spec: 05-spec-arc-help -->

Dynamic content that reads from README.md or other files at runtime

## (deferred) Argument parsing or per-skill views
...
## (deferred) Interactive menus or topic selection
...
## (deferred) Versioned help output
...
## (deferred) Modifying existing skills via help
...
## (deferred) Automatic spec deduplication
...
The analysis flags overlapping specs but does not merge or deduplicate them
...
## (deferred) Code refactoring suggestions
...
Code comment scanning extracts TODOs but does not suggest code changes

## (deferred) Modifying existing specs
...
Spec scanning is read-only; original specs are never modified or deleted
...
## (deferred) Changing backlog data format
...
## (deferred) Modifying other skills from capture
...
## (deferred) Changing priority levels
...
## (deferred) Modifying BACKLOG template
