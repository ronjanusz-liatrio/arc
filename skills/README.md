...
Arc provides five skills for managing the product idea lifecycle.
...
```
/arc-align → /arc-capture → /arc-shape → /arc-wave → /cw-spec → /cw-plan → /cw-dispatch
                                                  ↑
...
5. **Review** audits pipeline health at any point in the cycle — check backlog health, wave alignment, and cross-reference integrity
